...
| 错误类型 | 关键词 | 返回步骤 | 说明 |
|----------|--------|----------|------|
| **代码错误** | `undefined`, `type error`, `syntax error`, `Cannot find`, `expected`, `got` | Step 6 | 实现层面问题 |
| **需求理解错误** | `assertion failed`, `wrong result`, `logic error`, E2E 业务流程错误 | Step 4 | 需求理解偏差 |
| **环境问题** | `timeout`, `ECONNREFUSED`, `ENOTFOUND`, `service unavailable` | 重试 | 外部依赖问题 |
...
| 阶段 | 错误类型 | 返回步骤 |
|------|----------|----------|
| CI/CD Pipeline | 代码错误 | Step 6 |
| Integration Tests | 需求理解错误 | Step 4 |
| E2E Tests (current_fix_cases) | 代码/需求错误 | Step 4/6 |
