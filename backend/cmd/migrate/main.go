...
func main() {
	...
	if databaseURL == "" {
		databaseURL = "postgresql://pintuotuo:dev_password_123@localhost:5432/pintuotuo_db?sslmode=disable" //nolint:gosec // G101: Dev default credentials, intentionally set as fallback
	}
