...
import { Merchant, MerchantStats, MerchantSettlement, MerchantOrder, Product, MerchantAPIKey, APIKeyUsage, PaginatedResponse } from '@/types'
...
interface MerchantState {
  ...
  createAPIKey: (data: { name: string; provider: string; api_key: string; api_secret?: string; quota_limit?: number }) => Promise<boolean>
