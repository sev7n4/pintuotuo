...
describe('referralStore', () => {
  ...
  test('fetchReferrals 成功获取邀请列表', async () => {
    const mockReferrals = [
      { id: 1, referrer_id: 1, referee_id: 2, code: 'TESTCODE123', status: 'completed', created_at: new Date().toISOString() },
      { id: 2, referrer_id: 1, referee_id: 3, code: 'TESTCODE123', status: 'pending', created_at: new Date().toISOString() },
    ]
  ...
  test('fetchRewards 成功获取返利记录', async () => {
    const mockRewards = [
      { id: 1, referral_id: 1, amount: 100, status: 'completed', created_at: new Date().toISOString() },
      { id: 2, referral_id: 2, amount: 50, status: 'pending', created_at: new Date().toISOString() },
    ]
