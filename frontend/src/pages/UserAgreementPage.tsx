      ...
      <Card>
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <Text type="secondary">最后更新日期：2026年4月16日</Text>
          </div>
          ...
          <div>
            ...
            <Paragraph>
              1. 用户通过本平台购买服务后，支付成功对应权益将自动发放；加油包（Token）按批次入账并以批次有效期管理。
            </Paragraph>
            <Paragraph>
              2. 在 strict 权益规则下，加油包不可单独购买，需与至少一个在售模型商品或套餐包组合购买；仅持有余额不代表自动获得任意模型调用权限。
            </Paragraph>
            <Paragraph>
              3. 拼团购买模式下，如拼团未能在规定时间内成功，系统将自动取消订单并全额退款。
            </Paragraph>
            <Paragraph>4. 已使用的Token不支持退款，未使用的Token可在有效期内申请退款。</Paragraph>
            <Paragraph>5. 退款申请审核通过后，款项将在1-3个工作日内原路退回。</Paragraph>
          </div>
