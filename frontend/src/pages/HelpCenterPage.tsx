    ...
    faqs: [
      {
        question: '如何购买Token？',
        answer:
          '加油包（Token）不可单独购买，需与至少一个在售模型商品或套餐包组合下单。支付成功后，Token会按批次入账并按到期优先扣减。',
      },
      {
        question: '拼团购买有什么优势？',
        answer:
    ...
    faqs: [
      {
        question: '如何使用Token？',
        answer:
          '购买成功后，Token会自动充值到您的账户。请注意：Token余额仅用于已订购模型权益范围内的调用。在"我的Token"页面可以查看余额、批次有效期和使用记录。',
      },
      {
        question: '支持哪些模型？',
        answer:
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        question: '忘记密码怎么办？',
        answer:
          '在登录页点击「忘记密码」，输入注册邮箱申请重置；查收邮件中的重置令牌后，在重置密码页设置新密码。若未收到邮件或仍无法登录，请联系客服。',
      },
      {
        question: '如何成为商家？',
        answer:
