      ...
      <Card>
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          ...
          <div>
            ...
            <Paragraph>请您在使用我们的服务前，仔细阅读并理解本隐私政策的全部内容。</Paragraph>
          </div>

          <div>
            <Title level={4}>一、我们收集的信息</Title>
            <Paragraph>为了向您提供服务，我们可能收集以下类型的信息：</Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              <strong>2. 交易信息</strong>
              <br />
              当您购买Token服务时，我们会收集订单信息、支付记录、Token使用记录等。
            </Paragraph>
            <Paragraph>
              <strong>3. 使用信息</strong>
              <br />
          ...
          <div>
            ...
            <Paragraph>我们收集的信息将用于：</Paragraph>
            <Paragraph>
              1. 提供和维护我们的服务；
              <br />
              2. 处理您的订单和支付；
          ...
          <div>
            ...
            <Paragraph>
              <strong>2. 安全措施</strong>
              <br />
              我们采用业界标准的安全措施保护您的个人信息，包括但不限于：
              <br />
              - 数据加密传输（HTTPS）
              <br />
              - 敏感信息加密存储
          ...
          <div>
            ...
            <Paragraph>
              1. <strong>服务提供商</strong>
              ：我们可能与服务提供商共享信息，以完成支付处理、数据分析等服务；
              <br />
              2. <strong>法律要求</strong>
              ：根据法律法规、法律程序或政府要求，我们可能需要披露您的信息；
              <br />
              3. <strong>业务转让</strong>
          ...
          <div>
            ...
            <Paragraph>您对您的个人信息享有以下权利：</Paragraph>
            <Paragraph>
              1. <strong>访问权</strong>：您有权访问我们持有的您的个人信息；
              <br />
              2. <strong>更正权</strong>：您有权要求更正不准确的个人信息；
              <br />
              3. <strong>删除权</strong>：您有权要求删除您的个人信息；
              <br />
          ...
          <div>
            ...
            <Paragraph>如果您对本隐私政策有任何疑问或建议，请通过以下方式联系我们：</Paragraph>
            <Paragraph>
              📧 邮箱：privacy@pintuotuo.com
              <br />
              📱 客服电话：400-888-8888
              <br />
              📪 地址：北京市海淀区中关村科技园
            </Paragraph>
            <Paragraph>我们将在15个工作日内回复您的请求。</Paragraph>
          </div>
