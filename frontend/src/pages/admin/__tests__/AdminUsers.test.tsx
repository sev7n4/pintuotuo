  ...
  beforeEach(async () => {
    ...
    mockFetch.mockResolvedValue({
      json: async () => ({
        code: 0,
        data: [
          { id: 1, email: 'admin@example.com', name: 'Admin', role: 'admin', created_at: '2024-01-01T00:00:00Z' },
          { id: 2, email: 'merchant@example.com', name: 'Merchant', role: 'merchant', created_at: '2024-01-02T00:00:00Z' },
          { id: 3, email: 'user@example.com', name: 'User', role: 'user', created_at: '2024-01-03T00:00:00Z' },
        ],
      }),
    })
