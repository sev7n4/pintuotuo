...
describe('RegisterPage Component', () => {
  ...
  test('submits form successfully as user', async () => {
    ...
    // 验证注册函数被调用
    await waitFor(() => {
      expect(mockRegister).toHaveBeenCalledWith('test@example.com', 'Test User', 'password123', 'user')
    })
  ...
  test('submits form successfully as merchant', async () => {
    ...
    // 验证注册函数被调用
    await waitFor(() => {
      expect(mockRegister).toHaveBeenCalledWith('merchant@example.com', 'Merchant User', 'password123', 'merchant')
    })
  ...
  test('handles registration error', async () => {
    ...
    // 验证注册函数被调用
    await waitFor(() => {
      expect(mockRegister).toHaveBeenCalledWith('existing@example.com', 'Test User', 'password123', 'user')
    })
