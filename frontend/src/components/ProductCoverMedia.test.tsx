...
jest.mock('./ProductCoverMedia.module.css', () => ({
  ...
  rootHero: 'rootHero',
  bgLayer: 'bgLayer',
  bgLayerDefault: 'bgLayerDefault',
  frostOverlay: 'frostOverlay',
  frostOverlayDefault: 'frostOverlayDefault',
  frostOverlaySurface: 'frostOverlaySurface',
  frostOverlayGrid: 'frostOverlayGrid',
  coverImg: 'coverImg',
  placeholder: 'placeholder',
  placeholderCompact: 'placeholderCompact',
  placeholderWide: 'placeholderWide',
